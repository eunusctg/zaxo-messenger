...
export const mockCallHistory: CallRecord[] = [
  { id: 'call-1', callerId: 'demo-user-1', callerName: 'Alex Morgan', callerNumber: '482-719-356', receiverId: 'user-2', receiverName: 'Sarah Chen', receiverNumber: '291-834-567', callType: 'video', status: 'completed', duration: 1847, timestamp: '2:34 PM', isGroup: false, callQuality: 'excellent', wasRecorded: false },
  { id: 'call-2', callerId: 'user-3', callerName: 'Marcus Johnson', callerNumber: '738-456-129', receiverId: 'demo-user-1', receiverName: 'Alex Morgan', receiverNumber: '482-719-356', callType: 'audio', status: 'missed', duration: 0, timestamp: '1:15 PM', isGroup: false, callQuality: 'good', wasRecorded: false },
  { id: 'call-3', callerId: 'demo-user-1', callerName: 'Alex Morgan', callerNumber: '482-719-356', receiverId: 'user-6', receiverName: 'Aisha Patel', receiverNumber: '193-678-452', callType: 'audio', status: 'completed', duration: 432, timestamp: '11:30 AM', isGroup: false, callQuality: 'excellent', wasRecorded: true },
  { id: 'call-4', callerId: 'user-4', callerName: 'Elena Rodriguez', callerNumber: '564-893-712', receiverId: 'demo-user-1', receiverName: 'Alex Morgan', receiverNumber: '482-719-356', callType: 'video', status: 'completed', duration: 2356, timestamp: 'Yesterday', isGroup: false, callQuality: 'good', wasRecorded: false },
  { id: 'call-5', callerId: 'demo-user-1', callerName: 'Alex Morgan', callerNumber: '482-719-356', receiverId: 'user-8', receiverName: 'Yuki Tanaka', receiverNumber: '381-547-629', callType: 'audio', status: 'outgoing', duration: 189, timestamp: 'Yesterday', isGroup: false, callQuality: 'fair', wasRecorded: false },
  { id: 'call-6', callerId: 'user-5', callerName: 'David Kim', callerNumber: '847-261-935', receiverId: 'demo-user-1', receiverName: 'Alex Morgan', receiverNumber: '482-719-356', callType: 'audio', status: 'missed', duration: 0, timestamp: 'Mon', isGroup: false, callQuality: 'good', wasRecorded: false },
  { id: 'call-7', callerId: 'demo-user-1', callerName: 'Alex Morgan', callerNumber: '482-719-356', receiverId: '', receiverName: 'Project Alpha Team', receiverNumber: '', callType: 'video', status: 'completed', duration: 3600, timestamp: 'Tue', isGroup: true, participants: [{ id: 'user-2', name: 'Sarah Chen' }, { id: 'user-3', name: 'Marcus Johnson' }, { id: 'user-6', name: 'Aisha Patel' }], callQuality: 'excellent', wasRecorded: true },
  { id: 'call-8', callerId: 'demo-user-1', callerName: 'Alex Morgan', callerNumber: '482-719-356', receiverId: '', receiverName: 'Family Group', receiverNumber: '', callType: 'audio', status: 'completed', duration: 720, timestamp: 'Wed', isGroup: true, participants: [{ id: 'user-5', name: 'David Kim' }, { id: 'user-7', name: 'James Wilson' }], callQuality: 'good', wasRecorded: false },
];
